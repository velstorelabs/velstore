...
return [
    ...
    'customers' => [
        ...
        'confirm_delete' => 'تأیید حذف',
        'delete_message' => 'آیا مطمئن هستید که می‌خواهید این مشتری را حذف کنید؟',
        'delete' => 'حذف',
        'cancel' => 'لغو',

        'success_create' => 'مشتری با موفقیت ایجاد شد!',
        'success_update' => 'مشتری با موفقیت به‌روزرسانی شد!',
        'success_delete' => 'مشتری با موفقیت حذف شد!',
        'error_delete' => 'خطا در حذف مشتری! لطفاً دوباره تلاش کنید.',
