...
return [
    ...
    'customers' => [
        ...
        'confirm_delete' => 'Подтвердите удаление',
        'delete_message' => 'Вы уверены, что хотите удалить этого клиента?',
        'delete' => 'Удалить',
        'cancel' => 'Отменить',

        'success_create' => 'Клиент успешно создан!',
        'success_update' => 'Клиент успешно обновлен!',
        'success_delete' => 'Клиент успешно удален!',
        'error_delete' => 'Ошибка при удалении клиента! Попробуйте снова.',
