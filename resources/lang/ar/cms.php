...
return [
  ...
  'sidebar' => [
    ...
    'customers' => [
        ...
        'confirm_delete' => 'تأكيد الحذف',
        'delete_message' => 'هل أنت متأكد أنك تريد حذف هذا العميل؟',
        'delete' => 'حذف',
        'cancel' => 'إلغاء',

        'success_create' => 'تم إنشاء العميل بنجاح!',
        'success_update' => 'تم تحديث بيانات العميل بنجاح!',
        'success_delete' => 'تم حذف العميل بنجاح!',
        'error_delete' => 'حدث خطأ أثناء حذف العميل! يرجى المحاولة مرة أخرى.',
